        ...
        <>
            ...
            <div className="fixed top-0 left-0 right-0 bg-card/90 backdrop-blur-md border-b border-border/50 z-50 p-4 flex items-center justify-between">
                ...
                <button 
                    ...
                    className="p-2 rounded-lg text-muted-foreground hover:bg-muted/50 hover:text-foreground transition-colors md:hidden"
                >
            ...
            <nav className={cn(
                "fixed top-16 left-0 h-full bg-card/90 backdrop-blur-md border-r border-border/50 z-40 w-64 transform transition-transform duration-300 ease-in-out md:hidden",
            ...
            <nav className="fixed left-0 top-0 h-full bg-card/90 backdrop-blur-md border-r border-border/50 z-40 w-64 hidden md:block">
                <div className="p-6 border-b border-border/50 flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center flex-shrink-0">
                        <Wifi size={20} className="text-primary-foreground" />
                    </div>
